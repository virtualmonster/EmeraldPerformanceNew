...
public class B2C_PlaceOrder_Test_A1EB576038322878C668B46665366137 extends LTTestScript  {
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public B2C_PlaceOrder_Test_A1EB576038322878C668B46665366137(IContainer container, String invocationId) {
		super(container, "B2C_PlaceOrder", invocationId, "A1EB576038322878C668B46665366137", "/OneTestAssets_B2C/Modules_B2C/B2C_PlaceOrder.testsuite", "C:/Users/stuart.walker/HCL/devopstest/EmeraldPerformanceTest/OneTestAssets_B2C/Modules_B2C/B2C_PlaceOrder.testsuite");
		setArmEnabled(false);
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
      ...
      this.add(page_1(this)); /* GENERIC CREATE TEMPLATE */
			...
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: B2C_PlaceOrder_Test_A1EB576038322878C668B46665366137 ",e);
	    } finally {
	        super.execute();
		}	    
    }
...
private HTTPPage page_1(final IContainer parent) {
			HTTPThink think = new HTTPThink(5668, 1, parent, parent, "A1EAF847C5066DE8C18CE53736636331");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "PlaceAnOrder", "A1EAF847C5066DE8C18CE53736636331") {
			...
			{ // Parallal Block Start
				...
				httpParallel.addRequest(0, request_1(this, true, "A1EAF847C4FCF7E7C18CE53736636331", false, false,
						"Config_2", "/wcs/resources/store/STOREID/cart/@self/precheckout?langId=LANGID",	"/wcs/resources/store/STOREID/cart/@self/precheckout?langId=LANGID", true, false), 0, 100, "null", 3);
				httpParallel.addRequest(0, request_2(this, false, "A1EAF847C4FCF7E7C18CE53736636331", true, true,
						"Config_2", "/wcs/resources/store/STOREID/cart/@self/checkout?langId=LANGID",	"/wcs/resources/store/STOREID/cart/@self/checkout?langId=LANGID", true, false), 0, 100, "null", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1EAF847C5066DECC18CE53736636331", getHTTPTest());
	...
	reqAction.addDataSub(subContainer_1);
		...
		ISubRule sub_0 = new SubRule("req_uri", 59, 6, true, (IDCCoreVar)vars[3], false, "langId", null, 0, false);
	subContainer_1.addSubInstruction(sub_0);
		ISubRule sub_1 = new SubRule("req_uri", 21, 7, true, (IDCCoreVar)vars[1], false, "store", null, 0, false);
	subContainer_1.addSubInstruction(sub_1);
		ISubRule sub_2 = new SubRule("req_hdr_Referer_1", 17, 9, false, (IDCCoreVar)vars[2], false, "Referer_3", null, 0, false);
	...
	subContainer_1.addSubInstruction(sub_4);
		ISubRule sub_5 = new SubRule("req_hdr_WCTrustedToken_1", 0, 14, false, (IDCCoreVar)vars[9], false, "WCTrustedToken", null, 0, false);
	subContainer_1.addSubInstruction(sub_5);
		ISubRule sub_6 = new SubRule("req_hdr_WCToken_1", 0, 7, false, (IDCCoreVar)vars[8], false, "WCToken", null, 0, false);
	subContainer_1.addSubInstruction(sub_6);
		ISubRule sub_7 = new SubRule("req_hdr_Host_1", 0, 8, false, (IDCCoreVar)vars[0], false, "Host", null, 0, false);
	subContainer_1.addSubInstruction(sub_7);
		ISubRule sub_8 = new SubRule("req_hdr_WCPersonalization_1", 0, 17, false, (IDCCoreVar)vars[7], false, "WCPersonalization", null, 0, false);
	subContainer_1.addSubInstruction(sub_8);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1EAF847C5066DEFC18CE53736636331",
			true,
			false
		);
...
String requestData_1 = strBuf_1.toString();
	...
	HTTPPostDataChunk pdc_0 = new HTTPPostDataChunk("A1EAF847C5066E3CC18CE53736636331", postData, requestData_1, "UTF-8", 0, 0);
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1EAF847C508DC03C18CE53736636331", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_2);
		...
		ISubRule sub_9 = new SubRule("req_uri", 56, 6, true, (IDCCoreVar)vars[3], false, "langId_2", null, 0, false);
	...
	subContainer_2.addSubInstruction(sub_10);
		ISubRule sub_11 = new SubRule("req_hdr_Referer_1", 17, 9, false, (IDCCoreVar)vars[2], false, "Referer_4", null, 0, false);
	...
	subContainer_2.addSubInstruction(sub_12);
		ISubRule sub_13 = new SubRule("req_hdr_Origin_1", 8, 8, false, (IDCCoreVar)vars[0], false, "Origin_2", null, 0, false);
	subContainer_2.addSubInstruction(sub_13);
		ISubRule sub_14 = new SubRule("req_hdr_WCTrustedToken_1", 0, 14, false, (IDCCoreVar)vars[9], false, "WCTrustedToken_2", null, 0, false);
	subContainer_2.addSubInstruction(sub_14);
		ISubRule sub_15 = new SubRule("req_hdr_WCToken_1", 0, 7, false, (IDCCoreVar)vars[8], false, "WCToken_2", null, 0, false);
	subContainer_2.addSubInstruction(sub_15);
		ISubRule sub_16 = new SubRule("req_hdr_Host_1", 0, 8, false, (IDCCoreVar)vars[0], false, "Host_2", null, 0, false);
	subContainer_2.addSubInstruction(sub_16);
		ISubRule sub_17 = new SubRule("req_hdr_WCPersonalization_1", 0, 17, false, (IDCCoreVar)vars[7], false, "WCPersonalization_2", null, 0, false);
	subContainer_2.addSubInstruction(sub_17);
	


		
				// wait on another action
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1EAF847C5066DECC18CE53736636331"), 3);		
		IConnectionRecord serverConnection = ConnectionRecordFactory.find(parent, 
				parallelGroup, connConfigName,
				true, // close connection at test boundary,
				null, 0, 1); // error behavior
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1EAF847C508DC06C18CE53736636331",
			true,
			false
		);
...
String requestData_2 = strBuf_2.toString();
	...
	HTTPPostDataChunk pdc_1 = new HTTPPostDataChunk("A1EAF847C508DC53C18CE53736636331", postData, requestData_2, "UTF-8", 0, 0);
