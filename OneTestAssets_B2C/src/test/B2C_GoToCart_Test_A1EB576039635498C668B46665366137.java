...
public class B2C_GoToCart_Test_A1EB576039635498C668B46665366137 extends LTTestScript  {
...
private HTTPTestScriptHelper httpTestScriptHelper;
	...
	public B2C_GoToCart_Test_A1EB576039635498C668B46665366137(IContainer container, String invocationId) {
		super(container, "B2C_GoToCart", invocationId, "A1EB576039635498C668B46665366137", "/OneTestAssets_B2C/Modules_B2C/B2C_GoToCart.testsuite", "C:/Users/stuart.walker/HCL/devopstest/EmeraldPerformanceTest/OneTestAssets_B2C/Modules_B2C/B2C_GoToCart.testsuite");
		setArmEnabled(false);
...
this.addEventBehavior(new RPTEventStructure(new HTTPPageTitleVPEvent(), new RPTContinueEvent("Page title verification failed"), 1, "Page title verification failed"));
	...
	this.addEventBehavior(new RPTEventStructure(new RPTCustomCodeExceptionEvent(), new RPTStopUserEvent("Custom Code reported an unhandled exception"), 1, "Custom Code reported an unhandled exception"));
      ...
      this.add(page_1(this)); /* GENERIC CREATE TEMPLATE */
			...
			this.httpTestScriptHelper.executeHelper();
		     ...
		     log("Test Execution: B2C_GoToCart_Test_A1EB576039635498C668B46665366137 ",e);
	    } finally {
	        super.execute();
		}	    
    }
	...
	VariableAction vc = new VariableAction(parent, "", "A1EAF46CFA62B69EE6D6B53662323963");	
		...
		vars[9] = new DataVar("SKUs", "-1", IDataArea.VIRTUALUSER, "IGNORE", false, false);

	
		vars[10] = new DataVar("first_orderItemId", "-1", IDataArea.VIRTUALUSER, "IGNORE", false, false);
...
private HTTPPage page_1(final IContainer parent) {
			HTTPThink think = new HTTPThink(5999, 1, parent, parent, "A1EAF46CFD3C3D30E6D6B53662323963");
	parent.add(think);
	
		HTTPPage page = new HTTPPage(parent, "GoToCart", "A1EAF46CFD3C3D30E6D6B53662323963") {
			...
			{ // Parallal Block Start
				...
				httpParallel.addRequest(0, request_1(this, true, "A1EAF46CFD353980E6D6B53662323963", false, true,
						"Config_2", "HOSTNAME:443/wcs/resources/store/STOREID/cart/@self?currency=USD&sortOrderItemBy=orderItemID&langId=LANGID",	"/wcs/resources/store/STOREID/cart/@self?currency=USD&sortOrderItemBy=orderItemID&langId=LANGID", true, false), 0, 100, "null", 3);
			} // Parallal Block End 
...
{ // Parallal Block Start
				...
				// httpParallel.addRequest(int serial, HTTPAction action, int actionDelay, String firstCharSemID) 
				httpParallel.addRequest(0, request_2(this, true, "A1EAF46CFD353980E6D6B53662323963", true, false,
						"Config_2", "HOSTNAME:443/search/resources/api/v2/products?currency=USD&id=SKUs&storeId=STOREID&langId=LANGID",	"/search/resources/api/v2/products?currency=USD&id=SKUs&storeId=STOREID&langId=LANGID", true, false), 0, 100, "null", 3);
			} // Parallal Block End 
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1EAF46CFD3C3E0BE6D6B53662323963", getHTTPTest());
		...
		headers.add(new RequestHeaderData("Referer", "https://HOSTNAME/STORENAME/cart", "UTF-8", 1));			
	...
	harvestContainer_1.addHarvestInstruction ("resp_content", dcVars[1], "\"orderItemId\":\"(.*?)\"", 1, 1, 0, 0, false, "Content: orderItemId", null, 0, false);
	IDataSub subContainer_1 = new DataSub();
	reqAction.addDataSub(subContainer_1);

		ISubRule sub_0 = new SubRule("req_uri", 88, 6, true, (IDCCoreVar)vars[3], false, "langId_85", null, 0, false);
	subContainer_1.addSubInstruction(sub_0);
		ISubRule sub_1 = new SubRule("req_uri", 21, 7, true, (IDCCoreVar)vars[1], false, "store", null, 0, false);
	subContainer_1.addSubInstruction(sub_1);
		ISubRule sub_2 = new SubRule("req_hdr_Referer_1", 17, 9, false, (IDCCoreVar)vars[2], false, "Referer_72", null, 0, false);
	subContainer_1.addSubInstruction(sub_2);
		ISubRule sub_3 = new SubRule("req_hdr_Referer_1", 8, 8, false, (IDCCoreVar)vars[0], false, "Referer_70", null, 0, false);
	subContainer_1.addSubInstruction(sub_3);
		ISubRule sub_4 = new SubRule("req_hdr_Host_1", 0, 8, false, (IDCCoreVar)vars[0], false, "Host_179", null, 0, false);
	subContainer_1.addSubInstruction(sub_4);
		ISubRule sub_5 = new SubRule("req_hdr_WCTrustedToken_1", 0, 14, false, (IDCCoreVar)vars[8], false, "WCTrustedToken_30", null, 0, false);
	...
	subContainer_1.addSubInstruction(sub_7);
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1EAF46CFD3C3E0EE6D6B53662323963",
			true,
			false
		);
	...
	public class CustomCode_1 extends CustomCodeAction {
		...
		public CustomCode_1(IContainer parent, IDataCorrelationVar outVar) {
			super(parent, "customcode.PickAllSKUsFromCart_914", "A1EB3100176E7CD0E102B26134363839");
			this.outVar = outVar;
		}
		...
		public void execute() {
			...
			ICustomCode2 ccclass = 	new customcode.PickAllSKUsFromCart_914();
...
private AssignVariableAction dataVarAssign_1(final IContainer parent) {
	AssignVariableAction varAction = new AssignVariableAction(parent, "A1EB31003AB82600E102B26134363839");
	...
	private If ltIf_1(IContainer parent) {
		If ifObj = new If(parent, "If", "A1EAF829195AF380E6D6B53662323963");
	...
	private  IStringComparison stringComparison_1(IContainer parent) {
		IStringComparison cond = new com.ibm.rational.test.lt.compare.StringEquals(parent, "stringComparison_1", "A1EAF829195AF383E6D6B53662323963");
	...
	private Container ltContainer_1(final IContainer parent) {
		Container container = new Container(parent, "Then Block", "A1EAF829195AF391E6D6B53662323963") {

            public void execute() {                
                     	this.add(new TestFlowControlAction(this, "A1EAF829142FB580E6D6B53662323963",
	...
	{	
		...
		HTTPAction reqAction = new HTTPAction(parent, actionName, "A1EAF46CFD3C3E95E6D6B53662323963", getHTTPTest());
		HTTPPage myPage = reqAction.getPage();
	...
	reqAction.addDataSub(subContainer_2);
		...
		ISubRule sub_8 = new SubRule("req_uri", 78, 6, true, (IDCCoreVar)vars[3], false, "langId_86", null, 0, false);
	subContainer_2.addSubInstruction(sub_8);
		ISubRule sub_9 = new SubRule("req_uri", 63, 7, true, (IDCCoreVar)vars[1], false, "storeId_39", null, 0, false);
	subContainer_2.addSubInstruction(sub_9);
		ISubRule sub_10 = new SubRule("req_uri", 50, 4, false, (IDCCoreVar)vars[9], false, "id_22", null, 0, false);
	subContainer_2.addSubInstruction(sub_10);
		ISubRule sub_11 = new SubRule("req_hdr_Referer_1", 17, 9, false, (IDCCoreVar)vars[2], false, "Referer_73", null, 0, false);
	subContainer_2.addSubInstruction(sub_11);
		ISubRule sub_12 = new SubRule("req_hdr_Referer_1", 8, 8, false, (IDCCoreVar)vars[0], false, "Referer_71", null, 0, false);
	subContainer_2.addSubInstruction(sub_12);
		ISubRule sub_13 = new SubRule("req_hdr_Host_1", 0, 8, false, (IDCCoreVar)vars[0], false, "Host_180", null, 0, false);
	subContainer_2.addSubInstruction(sub_13);
		...
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1EAF46CFD3C3E0BE6D6B53662323963"), 3);
		// wait on another action
		reqAction.addSemaphoreWait((IKAction)myPage.getActionMap().get("A1EAF46CFD3C3E0BE6D6B53662323963"), 3);		
		IConnectionRecord serverConnection = ConnectionRecordFactory.find(parent, 
				parallelGroup, connConfigName,
		...
		IHTTPRequest req = new HTTPRequest(
			...
			"UTF-8",
			"UTF-8",
			"A1EAF46CFD3C3E98E6D6B53662323963",
			true,
			false
		);
...
private AssignVariableAction dataVarAssign_2(final IContainer parent) {
	AssignVariableAction varAction = new AssignVariableAction(parent, "A1EAF8293C15A320E6D6B53662323963");
